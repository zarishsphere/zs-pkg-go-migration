...
golang-migrate wrapper — idempotent PostgreSQL 18.3 schema migrations
...
git clone https://github.com/zarishsphere/zs-pkg-go-migration.git
cd zs-pkg-go-migration
...
See [docs.zarishsphere.com/api/zs-pkg-go-migration](https://docs.zarishsphere.com/api/zs-pkg-go-migration) for the full OpenAPI 3.1 specification.
